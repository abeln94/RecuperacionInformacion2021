...
public class G_InferenciaOWL2 {
	...
	public static void main (String args[]) {
		...
		/*
		Al descomentar esas dos líneas se añaden propiedades extra relacionadas con esa inversa, por ejemplo el que ahora el modelo sabe que Luis es padre de Juan (antes no podía deducirlo).
		 */
    }
