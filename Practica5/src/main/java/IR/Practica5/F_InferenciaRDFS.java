...
public class F_InferenciaRDFS {
    ...
    public static void main(String args[]) {
        ...
        /*
        Se han inferido propiedades respecto a los elementos existentes, por ejemplo:
        Sabemos que Luis es hijo adoptivo de Juan, que 'hijo adoptivo' solo se da entre humanos, 'humanos' es subclase de 'animal' y 'animal' es subclase de 'mamífero' (no lo digo yo, lo dice quien ha hecho este código).
        Por lo tanto el modelo ha deducido, entre otros, que Luis y Juan son mamíferos.
         */
    }
